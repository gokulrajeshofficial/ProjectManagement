    ...
    bg-clip-text bg-gradient-to-l from-purple-800 to-pink-900 leading-none'>One app to control<span className='lg:text-5xl text-3xl'> and manage everything</span> </h1>
                        ...
                        <section className='my-5'>
                            <form onSubmit={handleSubmit}>
                                <div class="relative">
                                    <input type="search" onChange={handleChange} id="search" class="block w-full p-3.5 pl-10 text-sm text-fuchsia-900 border border-purple-300 rounded-lg bg-purple-50 focus:ring-purple-500 focus:border-fuchsia-500" placeholder="Enter your email" />
                                    <button type="submit" class="text-white absolute right-0 top-0 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-fuchsia-900  hover:to-purple-700   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm2 px-5 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Get started</button>
                                </div>
                            </form>
