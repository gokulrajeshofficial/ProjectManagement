                    ...
                    <form className="gird grid-flow-row gap-y-36">
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-6 group">
                                ...
                                <p className="text-red-600 lg:text-sm2 text-sm ">{errors?.fname}</p>
                            </div>
                            <div className="relative z-0 w-full mb-6 group">
                                ...
                                <p className="text-red-600 lg:text-sm2 text-sm">{errors?.lname}</p>
                            </div>
                        </div>
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-6 group">
                                ...
                                <p className="text-red-600 lg:text-sm2 text-sm">{errors?.phone}</p>
                            </div>
                            <div className="relative z-0 w-full mb-6 group">
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            ...
                            <p className="text-red-600 lg:text-sm2 text-sm">{errors?.password}</p>
                        </div>
                        <div className="relative z-0 w-full mb-6 group">
                            ...
                            <p className="text-red-600 lg:text-sm2 text-sm">{errors?.repeat_password}</p>
                        </div>
