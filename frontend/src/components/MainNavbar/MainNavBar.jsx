                ...
                <div className='flex items-center justify-between xl:max-w-7xl xl:mx-auto max-w-full px-[4%] flex-wrap w-full'>
                    <div className='flex items-center'>
                        ...
                        <div className='mt-2 mx-1'>
                            <h1 className='font-extrabold leading-5 text-transparent tracking-wide 
                 text-l bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Phoenix  </h1>
                    ...
                    <nav className={`${open == true ? "block" : "hidden"} lg:flex lg:items-center lg:w-auto w-full ms-auto`}>
                        <ul className='lg:flex lg:justify-between '>
                         ...
                         text-white font-bold  py-2 px-4 mx-1 lg:w-40 rounded font-lily'>Login</button></li>
                         ...
                         font-bold py-2 px-4 mx-1 rounded font-lily lg:w-40 w-full'>Register</button></li>
                        </ul>
